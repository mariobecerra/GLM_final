...
(rmse_test_9 <- mean(preds_test_9$res^2))
(rmse_test_log_9 <- mean((preds_test_9$mean - log(preds_test_9$obs))^2))
...
#### Modelo 11: Jerárquico con vecinadirios y distritos, tipo de edificio como covariable y pendientes e interceptos distintos
