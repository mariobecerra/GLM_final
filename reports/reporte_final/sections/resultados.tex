...
En el mapa de arriba de la figura \ref{fig:res_map_alpha} hay algunos espacios blancos, los cuales corresponden a códigos postales sin ventas. Se puede hacer una predicción con base en las distribuciones de las jerarquías que le corresponden, y al hacer esto, se tiene como resultado el mapa de abajo. %Por ejemplo, si el código postal 01025 no tiene datos para una predicción, entonces, suponiendo que este código postal esté en el vecindario de Upper Manhattan, una estimación de 
